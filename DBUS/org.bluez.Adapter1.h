 ...
 * Command line was: qdbusxml2cpp -p org.bluez.Adapter1 org.bluez.Adapter1.xml
 *
...
public:
    ...
    inline QString addressType() const
    { return qvariant_cast< QString >(property("AddressType")); }
    ...
    Q_PROPERTY(uint _Class READ _class)
    inline uint _class() const
...
public Q_SLOTS: // METHODS
    inline QDBusPendingReply<QDBusObjectPath> ConnectDevice(const QString &Address, const QString &AddressType)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(Address) << QVariant::fromValue(AddressType);
        return asyncCallWithArgumentList(QStringLiteral("ConnectDevice"), argumentList);
    }

    inline QDBusPendingReply<QVariantMap> GetDiscoveryFilters()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QStringLiteral("GetDiscoveryFilters"), argumentList);
    }
    ...
    inline QDBusPendingReply<> SetDiscoveryFilter(const QVariantMap &filter)
    {
        QList<QVariant> argumentList;
